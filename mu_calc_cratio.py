...
rib_length = 0.585 * plate_radius*0.8
...
#
matname = 'PDMS'
E = 2.82e3  #  PDMS Young modulus (Sylgard 184) N/mm^2
Nu = 0.421  #  PDMS Poisson's ratio

matname2 = 'GLASS'
E2 = 50e9  #  glass Young modulus
...
make_stl_internal_faces(internal_face_file,number_of_ribs,rib_length,rib_width,rib_radius,plate_thickness)
